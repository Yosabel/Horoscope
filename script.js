...
function determineSign(month,day) {
    ...
    if((month==3 && day>=21)|| (month==4 && day<=19)){
        ...
        return name + " you are an Aries!  Your mind should be especially quick and agile today, and your curiosity will be " +
    ...
    if((month==4 && day<=20)|| (month==5 && day<=20)){
        ...
        return name +" you are a Taurus! You might have a few projects in mind that you'll want to work on today. Your mind is" +
    ...
    if((month==5 && day>=21)|| (month==6 && day<=20)){
        ...
        return name +" you are a Gemini! Your mind may turn toward intellectual pursuits that you have been too busy to " +
    ...
    if((month==6 && day>=21)|| (month==7 && day<=22)){
        ...
        return name +" you are a Cancer! Legal papers regarding money might need to be executed today. Your mind is especially" +
    ...
    if((month==7 && day>=23)|| (month==8 && day<=22)){
        ...
        return name +" you are a Leo! A close friend or romantic partner might not seem communicative today and you might " +
    ...
    if((month==8 && day>=23)|| (month==9 && day<=22)){
        ...
        return name +" you are a Virgo! Do you have a garden or some houseplants that seem a little droopy? Don't worry about " +
    ...
    if((month==9 && day>=23)|| (month==10 && day<=22)){
        ...
        return name +" you are a Libra! Today close friends, a love partner, or children may appear to be in a quiet, " +
    ...
    if((month==10 && day>=23)|| (month==11 && day<=21)){
        ...
        return name +" you are a Scorpio! Home responsibilities may increase markedly today, leaving you feeling like you're " +
    ...
    if((month==11 && day>=22)|| (month==12 && day<=21)){
        ...
        return name +" you are a Sagittarius! You may be about to change jobs or move up the ranks. It's not the corner office" +
